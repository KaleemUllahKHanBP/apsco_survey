...
//
//   List<sysSurveyQuestionOptionModel> surveyOptions =
...
//     await DatabaseHelper.getGtcSurveyDataList(workingId).then((value) async {
...
//       imagesNameList.add(
//           "${userName}_${questionId}_${DateTime.now().millisecondsSinceEpoch}$extension");
...
//         Utils.showSnackBar("Please Select one options please", SnackType.error);
//         return;
//       }
...
//
//
//     else if (surveyQuestions[currentIndex.value].sysSurveyAnswerType == "number" ||
//         surveyQuestions[currentIndex.value].sysSurveyAnswerType == "text") {
//       if (valueControllerComment.value.text.isEmpty) {
//         Utils.showSnackBar("Please Add count in field", SnackType.error);
//         return;
//       } else {
//         if(surveyQuestions[currentIndex.value].sysOnYesGetImage == "Y") {
//           print(imagesNameList.length);
...
//
//     }
//     else if (surveyQuestions[currentIndex.value].sysSurveyAnswerType ==
//         "image") {
...
//         imagesName = imagesNameList.join(',');
//       } else {
//         Utils.showSnackBar("Please take at least one image", SnackType.error);
//         return;
//       }
//     }
//
...
//     // }
//
//     await insertGtcSurveyAnswer(surveyQuestions[currentIndex.value].id,
//         answerText, selectedAnswerOption, imagesName, context);
//   }
//
//   insertGtcSurveyAnswer(
//       int questionId,
//       String answerText,
//       String selectedAnswerOption,
//       String imageNames,
//       BuildContext context) async {
//     await DatabaseHelper.updateGtcSurveyItem(
//             questionId.toString(),
//             surveyQuestions[currentIndex.value].gcsStatus,
...
//             '${dirPath.value}/apscoSurvey/$workingId/${AppConstants.epscoSurvey}';
...
//           await takePicture(context, imagesList[i], imagesNameList[i],
//                   workingId, AppConstants.epscoSurvey)
//               .then((value) => {
//                     if (currentIndex.value == surveyQuestions.length)
//                   Utils.showSnackBar("Data Saved Successfully", SnackType.success),
//                   })
//               .catchError((e) => {
//           Utils.showSnackBar("Error! ${e.toString()} ", SnackType.error),
//                   });
//         }
//       }
...
//
//       final String folderPath =
//           '$dirPath/apscoSurvey/$workingId/${AppConstants.epscoSurvey}';
//       print("******************");
//       print(folderPath);
...
//   // }
//   void selectRadio(int index, String value) {
//     print("Selected '$value' for question $index");
//     answersRadio[index] = value;
//     refresh();
//   }
//
...
class ApscoSurveyController extends GetxController {
  ...
  // List<GtcSurveyRequestData> apscoSurveyImageList = [];
...
Utils.showSnackBar("Survey upload started", SnackType.success);
