...
import '../../../utils/dialog/delete_dialog.dart';
                  ...
                  if(selectedAnswerRadio == "Yes" && onYesGetImage == "Y")
                    Container(
                      ...
                      child: isImageLoading
                        ...
                        onSelectImage: () {
                          getImage();
                        }, isRequried: true, onDeleteImage: (int index) {
                        DeleteDialog.show(context, imageName:index);
                      },
                      ),
                    ),
                  if(answerType == "number" && onYesGetImage == "Y")
                    Container(
                      ...
                      child: isImageLoading
                        ...
                        onSelectImage: () {
                          getImage();
                        }, isRequried: false, onDeleteImage: (int index) {
                        DeleteDialog.show(context, imageName:index);
                      },
                      ),
                    ),
